...
`/auth` [Kullanıcı adı veya bir mesajını yanıtlayıp komutu gönderin.] 
- Grupta Auth kullanıcılar listesine ekler.

`/unauth` [Kullanıcı adı veya bir mesajını yanıtlayıp komutu gönderin.] 
- Grupta Auth kullanıcılar listesinden çıkarır.

`/authusers` 
- Mevcut Auth kullanıcı listesini gösterir.
"""
