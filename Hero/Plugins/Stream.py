...
__MODULE__ = "ᴏʏɴᴀᴛᴍᴀ ᴋᴏᴍᴜᴛᴜ"
__HELP__ = f"""

`/oynat` [Şarkıya yanıt olarak] ya da [YT Linki] ya da [Şarkı Adı]
- Sesli sohbette şarkı oynatır

`/voynat` [Video'ya yanıt olarak] ya da [YT Linki] ya da [Şarkı Adı]
